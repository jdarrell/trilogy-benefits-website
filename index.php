			...
			<div class="span12">
				<div class="intro-wrapper">
					<div class="intro-header text-center">
						<h3>Health care solutions tailored to you.</h3>
					</div>
					<div class="row-fluid">
						<div class="body-wrapper">
							<div class="span4 offset2">
								<div class="intro-who text-center">
									<h4>Who we are:</h4>
						      <p>Trilogy Benefits is a full-service consulting/brokerage firm providing professional guidance to business owners, managers and human resource professionals. </p>
						  	</div>
							</div>
							<div class="span4">
								<div class="intro-what text-center">
									<h4>What we do:</h4>
									<p>We offer customized employer and individual solutions to the ever-concerning health care crisis.</p>
								</div>
							</div>
						</div>
					</div>
					<div class="text-center">
						<a href="#" target="_blank" class="btn btn-primary btn-large">Contact Us To Get Started!</a>
					</div>
				</div>
			</div>
		</div>
		  ...
		  <div class="span12">
		  	<div class="market-wrapper">
			  	...
			  	<div class="market">
			  		...
			  		<!-- <img src="images/main-image2.png" id="main-image" alt="#"> -->
			  		<div class="TB-employer text-center"><p>Minimize costs</p></div>
			  		<div class="TB-employees text-center"><p>Maximize employee benefits</p><p>Educate employees</p></div>
			  	</div>
			  	<div class="market-footer text-center">
			  		<p>We optimize benefit packages to meet company <strong>and</strong> employee needs.</p>
			  	</div>
		  ...
		  <div class="span12">
		  	<div class="vid-wrapper">
			  	<div class="vid-header text-center">
			  		<h3>Are you ready for Health Care Reform?</h3>
			  	</div>
			  	<div class="vid">
			  		<img src="http://placehold.it/640x390" id="youtube-video" alt="#">
			  		<!-- <object id="youtube-video" width="640" height="360"><param name="movie" value="//www.youtube.com/v/JZkk6ueZt-U?hl=en_US&amp;version=3&amp;rel=0"></param><param name="allowFullScreen" value="true"></param><param name="allowscriptaccess" value="always"></param><embed src="//www.youtube.com/v/JZkk6ueZt-U?hl=en_US&amp;version=3&amp;rel=0" type="application/x-shockwave-flash" width="640" height="360" allowscriptaccess="always" allowfullscreen="true"></embed></object> -->
			  	</div>
		  	</div>
		  </div>			
		</div>
						...
						<li class="span4">						
	    					...
	    					<div class="accordion-heading">
	    						<div class="thumbnail accordion-toggle" data-toggle="collapse" data-parent="#learnmore" href="#legislative">
										...
										<!-- <img src="images/puzzle-legislative-small1.png" alt="#"> -->
										<div class="caption text-center">
											<p>Health Care Reform path to success: One of the requirements from Health and Human Services (HHS) is for employer groups to provide notification to all employees by October 1, 2013...</p>
							...
							<div class="accordion-group">
								<div class="accordion-heading">
									<div class="thumbnail accordion-toggle" data-toggle="collapse" data-parent="#learnmore" href="#groupservices">
										...
										<!-- <img src="images/puzzle-group-services-small1.png" alt="#"> -->
										<div class="caption text-center">
		    					...
		    					<div class="accordion-inner text-center">
		    						...
		    						<p><a href="#" class="btn btn-primary btn-large">contact us to get started</a></p>
		    					</div>
		    				</div>
		    			</div>
						</li>
							...
							<div class="accordion-group" id="individual">
								<div class="accordion-heading">
									<div class="thumbnail accordion-toggle">
										...
										<!-- <img src="images/puzzle-individual-services-small1.png" alt="#" data-toggle="collapse" data-parent="#learnmore" href="#indservices"> -->
										<div class="caption text-center">
											...
											<p><a class="btn btn-success" data-toggle="collapse" data-parent="#learnmore" href="#indservices">learn more</a>	<a href="#" class="btn btn-warning">get a quote</a></p>
										</div>
									</div>
								</div>
	  				...
	  				<div class="carousel-inner"><!--outer container-->
	  					<div class="item active"><!--inner container-->
	  						<div class="carousel-testimonial text-center">
	  							<p class="quote">"Trilogy Benefits has assisted with our employee benefits and provided us with human resource compliance with new hire/termination packets...At renewal time, they do research and provide several different options while making recommendations about the best course of action..."</p>
	  							<div class="author text-center">
	  								<p class="author-dash">&mdash;</p>
	  								<p class="author-info">Allen B.<br />Denver, Colorado</p>
	  								<p class="author-dash">&mdash;</p>
	  							</div>
	  						</div>
	  					</div>
	  					<div class="item">
	  						<div class="carousel-testimonial text-center">
	  							<p class="quote">"I have worked with Trilogy Benefits for over 15 years. Their team has handled numerous questions over the years to include medical, dental, life, and 401(k). We value and trust Trilogy Benefit's expertise with employee benefits and human resource compliance..."</p>
	  							<div class="author text-center">
	  								<p class="author-dash">&mdash;</p>
	  								<p class="author-info">Connie M.<br />Shawnee Mission, Kansas</p>
	  								<p class="author-dash">&mdash;</p>
	  							</div>
	  						</div>
	  					</div>
	  					<div class="item">
	  						<div class="carousel-testimonial text-center">
	  							<p class="quote">"Trilogy Benefits, Jacquie and Kathy, are absolutely fantastic. Trilogy Benefits is professional and most of all, they know their "stuff"!...They are at the top of their game as well as other business needs..."</p>
	  							<div class="author text-center">
	  								<p class="author-dash">&mdash;</p>
	  								<p class="author-info">Cheryl S.<br />Denver, Colorado</p>
	  								<p class="author-dash">&mdash;</p>
	  							</div>
	  						</div>
	  					</div>
		...
		<div class="row-fluid">
			<div class="span12">
				<div class="local text-center">
					...
					<!-- <img src="images/bigstock-denver-skyline-gimp.png" alt="#" id="gimp"> -->
					<div class="local-wrap">
						<img src="http://trilogybenefits.com/wp-content/uploads/2013/08/Colorado-Flag-small1.png" alt="#" class="local-content flag">
						<!-- <img src="images/Colorado-Flag-small1.png" alt="#" class="local-content flag"> -->
